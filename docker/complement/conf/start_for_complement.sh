...
echo "       POSTGRES_DRIVER=$POSTGRES_DRIVER"
echo "       SYNAPSE_COMPLEMENT_USE_WORKERS=$SYNAPSE_COMPLEMENT_USE_WORKERS"
echo "       SYNAPSE_COMPLEMENT_USE_ASYNCIO_REACTOR=$SYNAPSE_COMPLEMENT_USE_ASYNCIO_REACTOR"
...
case "$SYNAPSE_COMPLEMENT_DATABASE" in
  postgres)
    ...
    export POSTGRES_DRIVER=${POSTGRES_DRIVER:-psycopg2}
